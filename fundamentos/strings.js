...
console.log(escola.charAt(4)); // Function charAt serve para buscar na posição desejada o que está contido.
console.log(escola.charAt(5));

console.log(escola.charCodeAt(3)); // Function charCodeAt retorno o valor/código do caracter em unicode

console.log(escola.substring(1)); // Function substring pode ser parametrizado para não trazer o caracter de 1 colocação
...
console.log("Escola " + escola + " !!"); // Exemplo de concatenação padrão.
